...
namespace Doculyzer.Core.Services
{
    public class AzureOpenAIService : IAzureOpenAIService
    {
        ...
        public AzureOpenAIService(IAzureServiceFactory serviceFactory, IOptions<ServicesConfig> config)
        {
...
If you cannot answer based on the provided data, say so clearly.
"
            ;
